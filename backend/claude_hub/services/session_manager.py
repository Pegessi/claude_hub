...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, tab_id: str) -> None:
    ...
    def disconnect(self, websocket: WebSocket, tab_id: str) -> None:
    ...
    async def broadcast_to_tab(self, tab_id: str, message: str) -> None:
