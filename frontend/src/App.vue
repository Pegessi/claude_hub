...
:root {
  ...
  --ch-color-success-bg: rgba(74, 222, 128, 0.14);
  --ch-color-warning: #fbbf24;
  --ch-color-warning-strong: #f59e0b;
  --ch-color-warning-bg: rgba(251, 191, 36, 0.14);
  --ch-color-attention: #a78bfa;
  --ch-color-attention-strong: #8b5cf6;
  --ch-color-attention-bg: rgba(167, 139, 250, 0.15);
  --ch-color-info: #5fb8d8;
  --ch-color-danger: #f87171;
  --ch-color-danger-strong: #ef4444;
  --ch-color-danger-hover: #dc2626;
  --ch-color-danger-bg: rgba(239, 68, 68, 0.15);
  --ch-color-danger-border: rgba(239, 68, 68, 0.4);
...
:root[data-theme='light'] {
  ...
  --ch-color-success-strong: #15803d;
  --ch-color-success-hover: #166534;
  --ch-color-success-bg: #dcfce7;
  --ch-color-warning: #d97706;
  --ch-color-warning-strong: #b45309;
  --ch-color-warning-bg: #fef3c7;
  --ch-color-attention: #7c3aed;
  --ch-color-attention-strong: #6d28d9;
  --ch-color-attention-bg: #ede9fe;
  --ch-color-info: #457088;
  --ch-color-danger: #dc2626;
  --ch-color-danger-strong: #b91c1c;
  --ch-color-danger-hover: #991b1b;
  --ch-color-danger-bg: #fee2e2;
  --ch-color-danger-border: #fecaca;
