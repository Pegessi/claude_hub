...
import { goalStatusLabel, isGoalTerminal } from '@/utils/chatGoalPolicy'
...
const liveStatus = computed(() => `Goal ${needsReconciliation.value ? 'stop unconfirmed' : goalStatusLabel(props.goal.status)}`)
